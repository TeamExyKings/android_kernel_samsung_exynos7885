 ...
 */
 ...
 static struct fimc_is_sensor_cfg config_imx576_25M[] = {
	...
	FIMC_IS_SENSOR_CFG_EXT(2880, 2156,  30, 46,  0, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2880, 1620,  30, 46,  1, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2880, 1400,  30, 46,  2, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2156, 2156,  30, 46,  3, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2880, 1332,  30, 46,  4, CSI_DATA_LANES_4, 2054, 0, 0, 0),

	/*[5] REG_P : Full                               : 5760x4312@30*/
	/*[6] REG_AD: Single Still Capture (16:9)_Ver2   : 5760x3240@30*/
	/*[7] REG_AE: Single Still Capture (18.5:9)_Ver2 : 5760x2800@30*/
	/*[8] REG_AF: Single Still Capture (1:1)_Ver2    : 4312x4312@30*/
	/*[9] REG_AJ: Single Still Capture (19.5:9)_Ver2 : 5760x2664@30*/
	FIMC_IS_SENSOR_CFG_EXT(5760, 4312,  30, 46,  5, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(5760, 3240,  30, 46,  6, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(5760, 2800,  30, 46,  7, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(4312, 4312,  30, 46,  8, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(5760, 2664,  30, 46,  9, CSI_DATA_LANES_4, 2054, 0, 0, 0),

	/*[10]REG_AK: Single Still 3HDR (4:3)_Ver2       : 2880x2156@30*/
	/*[11]REG_AL: Single Still 3HDR (16:9)_Ver2      : 2880x1620@30*/
	/*[12]REG_AM: Single Still 3HDR (18.5:9)_Ver2    : 2880x1400@30*/
	/*[13]REG_AO: Single Still 3HDR (1:1)_Ver2       : 2156x2156@30*/
	/*[14]REG_AN: Single Still 3HDR (19.5:9)_Ver2    : 2880x1332@30*/
	FIMC_IS_SENSOR_CFG_EXT(2880, 2156,  30, 46, 10, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2880, 1620,  30, 46, 11, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2880, 1400,  30, 46, 12, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2156, 2156,  30, 46, 13, CSI_DATA_LANES_4, 2054, 0, 0, 0),
	FIMC_IS_SENSOR_CFG_EXT(2880, 1332,  30, 46, 14, CSI_DATA_LANES_4, 2054, 0, 0, 0),
...
int sensor_module_imx576_probe(struct platform_device *pdev)
{
	...
	ret = of_property_read_u32(dev->of_node, "enable_25M", &enable_25M);
	if (enable_25M) {
