...
#define REAR_IMX576_GC5035_V001_PDAF_CHECKSUM_LEN 	(0x24CF - 0x1F10 + 0x1)
...
const struct fimc_is_vender_rom_addr rear_imx576_gc5035_cal_addr = {
	...
	.rom_pdaf_checksum_len                     = REAR_IMX576_GC5035_V001_PDAF_CHECKSUM_LEN,
