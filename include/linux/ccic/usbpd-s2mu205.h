...
#define S2MU205_REG_VBUS_WAKEUP_DIS \
		(0x1 << S2MU205_REG_VBUS_WAKEUP_DIS_SHIFT) /* 0x02 */
...
#define S2MU205_REG_PLUG_CTRL_ECO_SRC_CAP_RDY \
		(0x1 << S2MU205_REG_PLUG_CTRL_ECO_SRC_CAP_RDY_SHIFT) /* 0x80 */
...
#define ENABLED_INT_1	(S2MU205_REG_INT_STATUS1_MSG_DR_SWAP |\
			...
			S2MU205_REG_INT_STATUS1_MSG_GETSNKCAP |\
			S2MU205_REG_INT_STATUS1_MSG_REJECT |\
			S2MU205_REG_INT_STATUS1_MSG_PSRDY)
#define ENABLED_INT_2	(S2MU205_REG_INT_STATUS2_MSG_SRC_CAP |\
			S2MU205_REG_INT_STATUS2_MSG_SNK_CAP |\
			S2MU205_REG_INT_STATUS2_MSG_REQUEST |\
			S2MU205_REG_INT_STATUS2_MSG_SOFTRESET |\
			S2MU205_REG_INT_STATUS2_MSG_VCONN_SWAP)
#define ENABLED_INT_2_WAKEUP	(S2MU205_REG_INT_STATUS2_MSG_SRC_CAP |\
			S2MU205_REG_INT_STATUS2_MSG_SNK_CAP |\
			S2MU205_REG_INT_STATUS2_MSG_REQUEST |\
			S2MU205_REG_INT_STATUS2_MSG_SOFTRESET |\
			S2MU205_REG_INT_STATUS2_MSG_VCONN_SWAP |\
